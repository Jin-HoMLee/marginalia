...
>
> ```bash
> uvx --from git+https://github.com/Jin-HoMLee/marginalia@v2.1.0 marginalia </dev/null
> ```

### Claude Code

```bash
claude mcp add --scope user marginalia -- uvx --from git+https://github.com/Jin-HoMLee/marginalia@v2.1.0 marginalia
```
